...
void GME_DlgRepUpdResize()
{
  ...
  SetWindowPos(GetDlgItem(hwd, PBM_DONWLOAD), NULL, 20, cli.bottom-220, cli.right-200, 20, SWP_NOZORDER);
  SetWindowPos(GetDlgItem(hwd, TXT_DOWNSPEED), NULL, cli.right-170, cli.bottom-216, 70, 16, SWP_NOZORDER);
